  ...
  return (
    <header className='w-full h-screen relative'>
      ...
      <div className='flex justify-center w-full md:w-0 absolute h-[60vh] top-0 md:top-[100%] md:h-0 md:left-1/2'>
        <div className='imgCentral bg-[#c6157fc9] w-[15rem] h-[15rem] md:w-[30rem] md:h-[30rem] 2xl:w-[45rem] 2xl:h-[45rem] rounded-full absolute z-10 bottom-0 md:left-1/2'>
          <img className='absolute bottom-0 w-[25rem] h-[15rem] md:w-[35rem] md:h-[25rem] 2xl:w-[50rem] 2xl:h-[40rem] ' src='https://firebasestorage.googleapis.com/v0/b/cactusproject-54bf0.appspot.com/o/Portada-removebg-preview.png?alt=media&token=cb1c9130-4bab-4aac-bcfc-e6d0543be2ce' alt='imagenCentral' />
